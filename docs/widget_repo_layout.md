...
* **theSrc/internal_www/data** - this area contains sets of widget config and state used in the test automation and the content area.
...
**Src Files**
* **theSrc/scripts/** - This is your ES6 source. This is what you change. There are more notes on the source code in the [how the code works](./how_the_code_works.md) docs. TODO dead link.
...
Excellent, it would be great if we had a yeoman style project template, but in the absense of that, follow the instructions in [exending the template](./extending_the_template.md). (TODO dead link)
